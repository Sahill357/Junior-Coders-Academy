...
const Regular = () => {
  useEffect(() => {
    document.title = 'Reguler'; // Set the title when the component mounts
    return () => {
  ...
  <div className="breadcumb-wrapper" data-bg-src="assets/img/bg/breadcrumb-bg-smoke2.jpg">
    <div className="container">
      <div className="breadcumb-content">
        <h1 className="breadcumb-title">Regular</h1>
      ...
      <div className="row ">
          ...
          <div className="class-box">
            <div className="class-img">
              <a href="class-details.html">
                <img src="https://img.freepik.com/premium-vector/thumbs-up-okay-gesture-character-design_188398-1728.jpg?size=626&ext=jpg" alt="class" />
              </a>
            </div>
            <div className="class-content">
              ...
              <Link to="/Beginner"   className="vs-btn style-1">Read More</Link>
            </div>
          </div>
        </div>
        {/* Single Class */}
        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <div className="class-box">
            <div className="class-img">
              <a href="class-details.html">
                <img src="https://img.freepik.com/premium-vector/happy-customer-service-character-illustration_188398-1545.jpg?size=626&ext=jpg" alt="class" />
              </a>
            </div>
            <div className="class-content">
              ...
              {/* <a href="class-details.html" className="vs-btn style-1">Read More</a> */}
              <Link to="/Intermediate"   className="vs-btn style-1">Read More</Link>
            </div>
          </div>
        </div>
        {/* Single Class */}
        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <div className="class-box">
            <div className="class-img">
              <a href="class-details.html">
                <img src="https://img.freepik.com/premium-vector/two-boys-with-laptops-learn-code-programming-vector-illustration_42417-100.jpg?w=740" alt="class" />
              </a>
            </div>
            <div className="class-content">
              ...
              {/* <a href="class-details.html" className="vs-btn style-1">Read More</a> */}
              <Link to="/Advanced"   className="vs-btn style-1">Read More</Link>
            </div>
          </div>
        </div>
        {/* Single Class */}
