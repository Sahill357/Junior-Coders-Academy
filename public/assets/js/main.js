(function ($) {
  ...
  */
  ...
  $(document).on('click', function (event) {
    if ($(event.target).is('.vs-menu-wrapper')) {
      if ($(".vs-menu-wrapper").hasClass("vs-body-visible")) {
        $(".vs-menu-wrapper").removeClass("vs-body-visible")
      }
    }
  });
  // let closeButton = $(".vs-menu-toggle").click(() => {
  //   $(".vs-menu-wrapper").addClass("vs-body-visible")
  // })
